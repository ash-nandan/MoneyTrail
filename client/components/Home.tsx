function Home () {
  return (
    <main>
      <section>
        <h1>MoneyTrail</h1>
        <p>Follow Where Your Money Goes!</p>
      </section>

      <section>
        <h2>About MoneyTrail</h2>
        <p>MoneyTrail is a personal finance application I'm building to better understand where my money goes and how my spending changes over time.</p>
      </section>
      ...
      <section>
        ...
        <p>MoneyTrail brings together two things I'm genuinely interested in: personal finances and software development. Instead of relying on my spreadsheet, I want to gradually build the tools 
          I use to understand my finances into my own fullstack web application.
        </p>
      </section>

      <section>
        <h2>Built With:</h2>
        <p>React | TypeScript | Node.js | SQL | Knex.js</p>
      </section>
    </main>
  )
}
